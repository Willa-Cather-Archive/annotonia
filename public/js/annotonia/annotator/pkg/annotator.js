          ...
          || Annotator.anno_ref_new
            ...
            && ! Annotator.Plugin.Offline.Store.localStorage.length) {
              ...
              if (Annotator.anno_ref_data[annotation.anno_ref_id] == undefined) {
                ...
                $.ajax(
                  "/annostore/search?_id="+ annotation.anno_ref_id
                  , {async: false}
                )
                  .done(function (data) {
            ...
            if (! (Annotator.anno_ref_data.invalid_ref
              ...
              if (! Annotator.is_offline) {
                ...
                Annotator.anno_ref_data[annotation.anno_ref_id].text += '<br><p><a href="/annotonia_status/edit.php?id='+ annotation.anno_ref_id  +'"><strong>&gt;&gt; Edit Referenced Annotation</strong></a></p>';
              }
